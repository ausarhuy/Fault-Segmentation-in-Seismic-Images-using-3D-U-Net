...
class SEBlock(Layer):
    def __init__(self, reduction_ratio, seed=2000, **kwargs):
...
def se_unet(input_shape=(None, None, None, 1), seed=2000) -> Model:
...
def inception_unet(input_shape=(None, None, None, 1), seed=2000) -> Model:
    inputs = Input(input_shape)
...
def inception_se_unet(input_shape=(None, None, None, 1), seed=2000) -> Model:
    ...
    # upsampling
    up6 = Conv3D(32, 2, activation='relu', padding='same',
                 kernel_initializer=GlorotNormal(seed=seed))(UpSampling3D(size=(2, 2, 2))(pool4))  # 8

    merge6 = Concatenate(axis=-1)([se4, up6])
    ...
    up7 = Conv3D(16, 2, activation='relu', padding='same',
                 kernel_initializer=GlorotNormal(seed=seed))(UpSampling3D(size=(2, 2, 2))(conv6))  # 16
    merge7 = Concatenate(axis=-1)([se3, up7])
    conv7 = Conv3D(16, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(merge7)
    conv7 = Conv3D(16, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(conv7)
    ...
    up8 = Conv3D(8, 2, activation='relu', padding='same',
                 kernel_initializer=GlorotNormal(seed=seed))(UpSampling3D(size=(2, 2, 2))(conv7))  # 32
    merge8 = Concatenate(axis=-1)([se2, up8])
    conv8 = Conv3D(8, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(merge8)
    conv8 = Conv3D(8, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(conv8)
    ...
    up9 = Conv3D(4, 2, activation='relu', padding='same',
                 kernel_initializer=GlorotNormal(seed=seed))(UpSampling3D(size=(2, 2, 2))(conv8))  # 64

    merge9 = Concatenate(axis=-1)([se1, up9])
    conv9 = Conv3D(4, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(merge9)
    conv9 = Conv3D(4, 3, activation='relu', padding='same',
                   kernel_initializer=GlorotNormal(seed=seed))(conv9)
...
def bistream_unet(input_shape=(None, None, None, 1), seed=2000) -> Model:
    inputs = Input(input_shape)
...
def bistream_se_unet(input_shape=(None, None, None, 1), seed=2000) -> Model:
    inputs = Input(input_shape)
